...
declare global {
  ...
  var controlPlaneWorkspaceEventListeners: Map<string, Set<WorkspaceEventListener>> | undefined
}

function getWorkspaceEventListeners() {
  if (!global.controlPlaneWorkspaceEventListeners) {
    global.controlPlaneWorkspaceEventListeners = new Map()
  }

  return global.controlPlaneWorkspaceEventListeners
}
