...
const DEFAULT_PROJECT_DESCRIPTION = 'Initial workspace generated by ClawStack.'
...
async function createPlannerTasks(input: {
  ...
  const prompt = [
    'You are the core planner for ClawStack, an AI Agent Management Platform.',
  ...
  return {
    projectSummary: 'Initial ClawStack workspace created from the setup wizard.',
    tasks: [
      {
